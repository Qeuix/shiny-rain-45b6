...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/shiny-rain-45b6
```

A live public deployment of this template is available at [https://shiny-rain-45b6.templates.workers.dev](https://shiny-rain-45b6.templates.workers.dev)
